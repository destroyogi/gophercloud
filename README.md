...
* [Reference documentation](http://godoc.org/github.com/yogeshwargnanasekaran/gophercloud)
...
```bash
go get github.com/yogeshwargnanasekaran/gophercloud

# Edit your code to import relevant packages from "github.com/yogeshwargnanasekaran/gophercloud"
...
```go
import "github.com/yogeshwargnanasekaran/gophercloud/openstack/compute/v2/servers"
...
[`servers.Server`](http://godoc.org/github.com/yogeshwargnanasekaran/gophercloud) struct).
...
to submit an issue to our [bug tracker](https://github.com/yogeshwargnanasekaran/gophercloud/issues).
