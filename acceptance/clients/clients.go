...
import (
	...
	baremetalHTTPBasic "github.com/yogeshwargnanasekaran/gophercloud/openstack/baremetal/httpbasic"
	baremetalNoAuth "github.com/yogeshwargnanasekaran/gophercloud/openstack/baremetal/noauth"
	blockstorageNoAuth "github.com/yogeshwargnanasekaran/gophercloud/openstack/blockstorage/noauth"
)
...
func AcceptanceTestChoicesFromEnv() (*AcceptanceTestChoices, error) {
	...
	/* // Temporarily disabled, see https://github.com/yogeshwargnanasekaran/gophercloud/issues/1345
	if networkID == "" {
